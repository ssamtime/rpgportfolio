...
public class RedDragonFSM : MonoBehaviour
{
    // 적 개체의 상태 분류
    enum EnemyState
    {
    ...
    [SerializeField] AudioClip redDragonDamagedAC;
    [SerializeField] AudioClip redDragonDeadAC;
    ...
    private void Awake()
    {
        ...
        rotationSpeed = 15.0f;
        currentTime = 0;
        attackDelay = 3.0f;     //오크랑다름
        attackPower = 40;
        attackRange = 4.5f;       //오크랑다름
    ...
    IEnumerator DeadProcess()
    {
        ...
        if (!isDeadAnim)
        {
            audioSource.PlayOneShot(redDragonDeadAC);
    ...
    {
        audioSource.PlayOneShot(redDragonDamagedAC);
